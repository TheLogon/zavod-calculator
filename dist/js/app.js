(() => {
          ...
          void 0 !== r &&
            ...
            (y(e[n]) && y(i[n])
              ? i[n].__swiper__
                ...
                : S(e[n], i[n])
              : !y(e[n]) && y(i[n])
              ? ((e[n] = {}), i[n].__swiper__ ? (e[n] = i[n]) : S(e[n], i[n]))
              : (e[n] = i[n]));
        }
      }
    }
  ...
  const A = {
    ...
    updateSlides: function () {
      ...
      for (let n = 0; n < p; n += 1) {
        ...
        const a = c.eq(n);
        if (
          (C && e.grid.updateSlide(n, a, p, t), "none" !== a.css("display"))
        ) {
      ...
      if (
        ...
        C && e.grid.updateWrapperSize(x, u, t),
        !i.centeredSlides)
      ) {
        const t = [];
  ...
  const D = {
    loopCreate: function () {
      ...
      for (let e = 0; e < l.length; e += 1)
        n.append(g(l[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = o.length - 1; e >= 0; e -= 1)
        n.prepend(g(o[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
    },
    loopFix: function () {
      const e = this;
  ...
  const R = {
      attachEvents: function () {
        ...
        (e.onTouchStart = G.bind(e)),
          ...
          (e.onClick = j.bind(e)),
          i.touch && !V && (t.addEventListener("touchstart", q), (V = !0)),
          W(e, "on");
      },
  ...
  function ie(e) {
    ...
    (s.autoplay = { running: !1, paused: !1 }),
      ...
      Object.assign(s.autoplay, { pause: c, run: o, start: l, stop: d });
  }
  function ne() {
  ...
  const ae = document.querySelector(".header"),
    oe = document.querySelector(".page");
  addEventListener("scroll", () => {
    ae.classList.contains("_header-scroll")
      ? oe.classList.add("header-padding")
      : oe.classList.remove("header-padding");
  }),
    (window.FLS = !0),
    (function (e) {
      let t = new Image();
                ...
                s.length > 0 &&
                  s.forEach((e, s) => {
                    t[s].setAttribute("data-tabs-title", ""),
                      ...
                      r && s == n[1] && t[s].classList.add("_tab-active"),
      ...
      function a(s) {
        ...
        if (i.closest("[data-tabs-title]")) {
          ...
          if (
            ...
            const s = r.querySelector("[data-tabs-title]._tab-active");
